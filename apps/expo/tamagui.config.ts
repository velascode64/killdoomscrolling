...
const config = createTamagui({
  ...
  themes: {
    ...
    light_Button: {
      background: "#483FFF",
      backgroundFocus: "#5B8CFF",
      backgroundHover: "#5B8CFF",
      backgroundPress: "#315BEA",
      backgroundStrong: "#315BEA",
      backgroundTransparent: "#EEF3FF",
      color: "#fff",
      colorFocus: "#fff",
      colorHover: "#fff",
      colorPress: "#fff",
      colorTransparent: "#483FFF",
      placeholderColor: "#878F9B",
    },
    light_Input: {
      background: "#FFFFFF",
      borderColor: "#E2E8F0",
      borderColorFocus: "#483FFF",
    },
    light_Checkbox: {
      borderColor: "#E2E8F0",
      background: "#FFFFFF",
