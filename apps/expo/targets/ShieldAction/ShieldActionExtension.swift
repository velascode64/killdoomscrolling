...
class ShieldActionExtension: ShieldActionDelegate {
  ...
  private let notificationTitle = "Rehabbit"
  private let notificationBody = "Toca para volver a Rehabbit y recuperar tu tiempo."
  ...
  private func handleAction(_ action: ShieldAction, completionHandler: @escaping (ShieldActionResponse) -> Void) {
    ...
    case .primaryButtonPressed:
      ...
      // Apple opens the app that owns this Family Controls shield. The app reads
      // the App Group flag and routes directly to its shared focus screen.
      complete(on: .openParentalControlsApp, completionHandler: completionHandler)
